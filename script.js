...
const translations = {
  en: {
    ...
    qualidata_period: 'Feb 2026 – Present',
    qualidata_desc: 'Development of an ETL pipeline to migrate data between databases. Development of reporting tools to analyze data. Design of scoring models.',
  ...
  fr: {
    ...
    label_contact: 'Contact',
    qualidata_role: 'Data Scientist',
    qualidata_period: 'Fév 2026 – Présent',
    qualidata_desc: "Développement d'un pipeline ETL pour migrer des données entre bases de données. Développement d'outils de reporting pour analyser les données. Conception de modèles de scoring.",
